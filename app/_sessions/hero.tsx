...
export function Hero() {
  return (
    <section id="home" className="bg-gradient-to-br from-white via-blue-50 to-indigo-50 text-black relative overflow-hidden">
      ...
      <Container className="relative z-10">
        <div className="grid lg:grid-cols-2 gap-16 items-center py-16 lg:py-24">
          ...
          <div className="text-center lg:text-left">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 leading-tight mb-6 bg-gradient-to-r from-gray-900 via-blue-900 to-indigo-900 bg-clip-text text-transparent">
            ...
            <div className="relative w-full max-w-2xl">
              ...
              <div className="grid grid-cols-2 gap-8 relative z-10">
                ...
                <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2 border border-gray-100/50">
                  ...
                  <p className="text-gray-600 text-sm">Sistema completo de reservas com mapa de assentos</p>
                </div>
                ...
                <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2 border border-gray-100/50">
                  ...
                  <h3 className="text-lg font-semibold text-gray-900 mb-2">Gestão de Pacotes</h3>
                  <p className="text-gray-600 text-sm">Crie e gerencie pacotes de viagem facilmente</p>
                </div>
                ...
                <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2 border border-gray-100/50">
                  ...
                  <p className="text-gray-600 text-sm">Controle financeiro integrado e relatórios</p>
                </div>
                ...
                <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2 border border-gray-100/50">
                  ...
                  <p className="text-gray-600 text-sm">Embarque digital com passagens na wallet</p>
                </div>
              </div>
            </div>
          </div>
